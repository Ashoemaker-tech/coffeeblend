    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="menu-entry">
              <a href="/product/{{ $product['id'] }}" class="img" style="background-image: url(images/{{ $product['image'] }});"></a>
              <div class="text text-center pt-4">
                <h3><a href="/product/{{ $product['id'] }}">{{ $product['name'] }}</a></h3>
                <p>{{ $product['description'] }}</p>
                <p class="price"><span>{{ $product['price'] }}</span></p>
                <p><a href="/product/{{ $product['id'] }}" class="btn btn-primary btn-outline-primary">Choose Options</a></p>
              </div>
            </div>
          </div>
        @endforeach
